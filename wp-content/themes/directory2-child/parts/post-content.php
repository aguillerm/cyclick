						...
						<div class="content">
							...
							<div class="item-image">
								<a class="main-link" href="{$link}">
									...
									{includePart "portal/parts/single-item-reviews-stars", item => $post, showCount => false}
							...
							<div class="item-data">
								...
								<div class="item-body">
									<div class="entry-content">
										<p class="txtrows-4">{if $post->hasExcerpt}{!$post->excerpt|striptags|trim|truncate: 240}{else}{!$post->content|striptags|trim|truncate: 250}{/if}</p>
									</div>
								</div>
